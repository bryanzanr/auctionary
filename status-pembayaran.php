...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			...
			<?php
				echo '
					<a href="bought.php?id='.$_GET['id'].'&command=bought" class="btn btn-success btn-block btn-register btn-lg">SUCCESS</a>	
				'
			?>

            </div>
            <div class="col-md-6">
            <a href="bought.php" class="btn btn-danger btn-block btn-register btn-lg">FAILED</a>
            </div>
			</div>
		</div>
